const PINYIN_MAP = {
  ...
  八: 'B', 巴: 'B', 白: 'B', 百: 'B', 拜: 'B', 柏: 'B', 板: 'B', 半: 'B', 包: 'B', 保: 'B', 宝: 'B', 报: 'B', 暴: 'B',
  北: 'B', 贝: 'B', 必: 'B', 碧: 'B', 博: 'B', 搏: 'B', 步: 'B',
  才: 'C', 财: 'C', 彩: 'C', 菜: 'C', 苍: 'C', 操: 'C', 潮: 'C', 车: 'C', 陈: 'C', 成: 'C', 城: 'C', 赤: 'C', 初: 'C', 楚: 'C', 创: 'C', 垂: 'C', 春: 'C', 磁: 'C', 翠: 'C',
  ...
  基: 'J', 击: 'J', 机: 'J', 激: 'J', 极: 'J', 吉: 'J', 即: 'J', 济: 'J', 记: 'J', 技: 'J', 季: 'J', 继: 'J', 佳: 'J', 家: 'J', 甲: 'J', 贾: 'J', 简: 'J', 建: 'J', 健: 'J', 剑: 'J', 鉴: 'J', 江: 'J', 姜: 'J', 将: 'J', 蒋: 'J', 交: 'J', 焦: 'J', 角: 'J', 教: 'J', 街: 'J', 节: 'J', 洁: 'J', 解: 'J', 金: 'J', 锦: 'J', 近: 'J', 进: 'J', 京: 'J', 经: 'J', 精: 'J', 景: 'J', 静: 'J', 镜: 'J', 酒: 'J', 久: 'J', 聚: 'J', 巨: 'J', 军: 'J', 均: 'J',
