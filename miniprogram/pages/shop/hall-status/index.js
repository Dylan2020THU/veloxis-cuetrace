...
Page({
  ...
  _loadByStore(storeId) {
    ...
    if (DEMO_MODE) {
      ...
      const TABLE_CONFIGS = [
        // ---- 桌型 ----
        { tableId: 'T1',  tableName: '1号桌',  bgColor: '#067EF9', tableTypeName: '乔氏金腿',   pricePerHour: 78,  status: 'occupied', elapsedH: 2, elapsedM: 35, elapsedS: 18, players: [{ openid: 'm1',  nickname: '张三',  avatar: '',    isCoach: false }, { openid: 'm2',  nickname: '李四',  avatar: '',    isCoach: false }, { openid: 'c1',  nickname: '陈教练', avatar: '/images/avatars/avatar-coach-chen.webp', isCoach: true,  teachH: 1, teachM: 48, teachS: 5 }] },
        { tableId: 'T2',  tableName: '2号桌',  bgColor: '#34c759', tableTypeName: '乔氏银腿',   pricePerHour: 68,  status: 'idle' },
        { tableId: 'T3',  tableName: '3号桌',  bgColor: '#ff6b35', tableTypeName: '中式八球',   pricePerHour: 50,  status: 'occupied', elapsedH: 0, elapsedM: 47, elapsedS: 33, players: [{ openid: 'm3',  nickname: '王五',  avatar: '',    isCoach: false }, { openid: 'c2',  nickname: '林教练', avatar: '/images/avatars/avatar-coach-lin.webp', isCoach: true,  teachH: 0, teachM: 25, teachS: 10 }] },
        { tableId: 'T4',  tableName: '4号桌',  bgColor: '#9b59b6', tableTypeName: '美式落袋',   pricePerHour: 90,  status: 'idle' },
        { tableId: 'T5',  tableName: '5号桌',  bgColor: '#e67e22', tableTypeName: '英式斯诺克', pricePerHour: 120, status: 'occupied', elapsedH: 1, elapsedM: 15, elapsedS: 5,  players: [{ openid: 'm4',  nickname: '赵六',  avatar: '',    isCoach: false }, { openid: 'm5',  nickname: '钱七',  avatar: '',    isCoach: false }] },
        { tableId: 'T6',  tableName: '6号桌',  bgColor: '#e91e8c', tableTypeName: '潘晓婷代言',  pricePerHour: 100, status: 'idle' },
        { tableId: 'T7',  tableName: '7号桌',  bgColor: '#00bcd4', tableTypeName: '开仑台',      pricePerHour: 60,  status: 'occupied', elapsedH: 0, elapsedM: 22, elapsedS: 45, players: [{ openid: 'm6',  nickname: '孙八',  avatar: '',    isCoach: false }, { openid: 'm7',  nickname: '周九',  avatar: '',    isCoach: false }, { openid: 'c3',  nickname: '王教练', avatar: '/images/avatars/avatar-coach-wang.webp', isCoach: true,  teachH: 0, teachM: 12, teachS: 30 }] },
        { tableId: 'T8',  tableName: '8号桌',  bgColor: '#067EF9', tableTypeName: '乔氏金腿',   pricePerHour: 78,  status: 'idle' },
        { tableId: 'T9',  tableName: '9号桌',  bgColor: '#34c759', tableTypeName: '乔氏银腿',   pricePerHour: 68,  status: 'occupied', elapsedH: 3, elapsedM: 5,  elapsedS: 0,  players: [{ openid: 'm8',  nickname: '吴十',  avatar: '',    isCoach: false }, { openid: 'c4',  nickname: '陈教练', avatar: '/images/avatars/avatar-coach-chen.webp', isCoach: true,  teachH: 1, teachM: 30, teachS: 0 }] },
        { tableId: 'T10', tableName: '10号桌', bgColor: '#ff6b35', tableTypeName: '中式八球',   pricePerHour: 50,  status: 'idle' },
        { tableId: 'T11', tableName: '11号桌', bgColor: '#9b59b6', tableTypeName: '美式落袋',   pricePerHour: 90,  status: 'occupied', elapsedH: 0, elapsedM: 58, elapsedS: 12, players: [{ openid: 'm9',  nickname: '郑十一', avatar: '',    isCoach: false }, { openid: 'm10', nickname: '冯十二', avatar: '',    isCoach: false }] },
        { tableId: 'T12', tableName: '12号桌', bgColor: '#e67e22', tableTypeName: '英式斯诺克', pricePerHour: 120, status: 'idle' },
        { tableId: 'T13', tableName: '13号桌', bgColor: '#e91e8c', tableTypeName: '潘晓婷代言',  pricePerHour: 100, status: 'occupied', elapsedH: 1, elapsedM: 42, elapsedS: 50, players: [{ openid: 'm11', nickname: '褚十三', avatar: '',    isCoach: false }, { openid: 'm12', nickname: '卫十四', avatar: '',    isCoach: false }, { openid: 'c5',  nickname: '林教练', avatar: '/images/avatars/avatar-coach-lin.webp', isCoach: true,  teachH: 0, teachM: 55, teachS: 20 }] },
        { tableId: 'T14', tableName: '14号桌', bgColor: '#00bcd4', tableTypeName: '开仑台',      pricePerHour: 60,  status: 'idle' },
        { tableId: 'T15', tableName: '15号桌', bgColor: '#067EF9', tableTypeName: '乔氏金腿',   pricePerHour: 78,  status: 'occupied', elapsedH: 0, elapsedM: 10, elapsedS: 5,  players: [{ openid: 'm13', nickname: '蒋十五', avatar: '',    isCoach: false }] },
