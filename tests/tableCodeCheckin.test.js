...
assert(
  tableJs.includes('joinTable()') &&
    ...
    tableJs.includes('data.getTableParticipants(this.data.storeId, this.data.tableId)') &&
    !tableJs.includes('data.getPendingCheckins(this.data.storeId)'),
