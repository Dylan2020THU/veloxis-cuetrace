...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \begin{scope}
    ...
    \node[anchor=center,inner sep=0pt] at (0.34,6.3) {\includegraphics[width=3.3cm]{coach_female.png}};
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \foreach \y/\ic/\t/\s in {5.25/教/{教练管理}/{统一管理本店台球教练}, 4.55/会/{会员训练统计}/{查看打卡天数与训练时长}}{
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      ...
      \begin{itemize}
        ...
        \item \textbf{教练管理}\\{\color{txtsub}\scriptsize 统一添加 / 移除、查看教练资料}
